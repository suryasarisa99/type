  ...
  useEffect(() => {
    ...
    rawKeys.forEach((key) => {
      if (key.classList.contains("dbl")) {
        ...
        keysRef.current[keyName0] = {
          key,
          shiftReq: true,
          isAlpha: false,
          hand: n[keyName0],
        };
        keysRef.current[keyName1] = {
          key,
          shiftReq: false,
          isAlpha: false,
          hand: n[keyName1],
    ...
    rightShiftKeyRef.current =
      keyboardRef.current.querySelector(".right-shift");
      ...
      <div className="keyboard" ref={keyboardRef}>
        <div className="row number-row">
          ...
          <div className="key num normal dbl">
            ...
            <div className="bt" value="0">
              0
            </div>
          </div>
          <div className="key normal dbl">
            <div className="top" value="_">
              _
            </div>
            <div className="bt" value="-">
              -
          ...
          <div className="key special backspace" value="Backspace">
            Backspace
          </div>
        </div>
        <div className="row">
          <div className="key special tab" value="Tab">
            Tab
          </div>
          <div className="key alpha normal" value="q">
            Q
          </div>
          <div className="key alpha normal" value="w">
            W
          </div>
          <div className="key alpha normal" value="e">
            E
          </div>
          <div className="key alpha normal" value="r">
            R
          </div>
          <div className="key alpha normal" value="t">
            T
          </div>
          <div className="key alpha normal" value="y">
            Y
          </div>
          <div className="key alpha normal" value="u">
            U
          </div>
          <div className="key alpha normal" value="i">
            I
          </div>
          <div className="key alpha normal" value="o">
            O
          </div>
          <div className="key alpha normal" value="p">
            P
          </div>
        ...
        <div className="row">
          <div className="key special capslock" value="CapsLock">
            Caps Lock
          </div>
          <div className="key alpha normal" value="a">
            A
          </div>
          <div className="key alpha normal" value="s">
            S
          </div>
          <div className="key alpha normal" value="d">
            D
          </div>
          <div className="key alpha normal" value="f">
            F
          </div>
          <div className="key alpha normal" value="g">
            G
          </div>
          <div className="key alpha normal" value="h">
            H
          </div>
          <div className="key alpha normal" value="j">
            J
          </div>
          <div className="key alpha normal" value="k">
            K
          </div>
          <div className="key alpha normal" value="l">
            L
          </div>
          <div className="key normal dbl">
            <div className="top" value=":">
          ...
          <div className="key special enter" value="Enter">
            Enter
          </div>
        </div>
        <div className="row">
          <div className="key special shift left-shift" value="left-shift">
            Shift
          </div>
          <div className="key alpha normal" value="z">
            Z
          </div>
          <div className="key alpha normal" value="x">
            X
          </div>
          <div className="key alpha normal" value="c">
            C
          </div>
          <div className="key alpha normal" value="v">
            V
          </div>
          <div className="key alpha normal" value="b">
            B
          </div>
          <div className="key alpha normal" value="n">
            N
          </div>
          <div className="key alpha normal" value="m">
            M
          </div>
          <div className="key alpha normal dbl">
            <div className="top" value="<">
          ...
          <div
            className="key alpha special shift right-shift"
            value="right-shift"
          >
            Shift
          </div>
        ...
        <div className="row space-row">
          ...
          <div className="key space" value="Space">
            {" "}
          </div>
          <div className="key alpha special alt">Alt</div>
          {!showGear ? (
            <div
              className="key alpha special ctrl right-ctrl"
              onClick={() => {
                setShowGear(true);
                setTimeout(() => {
                  goSettings();
